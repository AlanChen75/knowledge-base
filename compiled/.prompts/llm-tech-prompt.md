...
### [3/58] claude-token-efficient — 9 行 CLAUDE.md 減少 63% 輸出 token
...
### [4/58] 知識管理架構比較：LLM Knowledge Base vs SecondBrain → Notion
...
### [7/58] Cisco AI Agent 五步驟 vs 會計三表五步法 — 方法論對照與應用
...
### [8/58] Claude Code 會計三表案例分析 — AI 落地專業領域的實戰拆解
...
### [9/58] Claude Code 源碼洩漏分析 — 51.2 萬行 TypeScript 揭示的架構秘密
...
### [12/58] FDE 角色解析與 Smart4A 2026 轉型分析
...
### [13/58] MetaClaw 框架分析 — 自進化 AI Agent 整合方案
...
### [15/58] Jensen Huang Morgan Stanley TMT 科技大會演講重點
...
### [16/58] 玩爆你的龍蝦 — 最強 OpenClaw 安裝設定應用實機演練
...
### [17/58] OpenClaw Agent 省錢實戰：三個玩家的第一線經驗
...
### [23/58] AI 模型成本優化：用高階模型訓練低階模型的工作流
...
### [27/58] WiFi DensePose：無需攝影機的 WiFi 人體姿態追蹤系統
...
### [28/58] WFGY RAG 16 問題清單 - 語義防火牆診斷框架
...
### [29/58] QwenASR Int8 量化：8GB RAM 筆電也能跑的語音辨識
...
### [40/58] SHC v4 混合架構設計 — 固定模組 + 動態規劃 + Agent-Creator
...
### [41/58] PaddleOCR-VL-1.5 發布：0.9B 輕量級文件視覺語言模型
...
### [42/58] 3090 遠端壓力測試報告（20/30/50 學生）
...
### [43/58] vLLM Qwen2.5-7B-Instruct 在 RTX 3090 部署紀錄
...
### [54/58] Open NotebookLM - 開源版 NotebookLM 複刻專案
...
### [55/58] NotebookLM 簡報編輯器 - 免費修改簡報文字工具
...
### [56/58] VibeResearch - Claude Code 自動撰寫學術論文
...
### [57/58] Stanford CS146S: The Modern Software Developer
